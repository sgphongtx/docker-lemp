 ...
 * @author PhongTX
 */
class Core_Crawler_VnExpressArticle extends Core_Crawler_Abstract
{
    /**
    ...
    public static function parse($html)
    {
         ...
         * Get title 
         */
        $titleNode = $dom->query('div.title_news h1');
        ...
        //$response['data']['content'] = preg_replace('/<p class="pTitle">([\\S\\s]*?)<\/p>/','',$response['data']['content']);
